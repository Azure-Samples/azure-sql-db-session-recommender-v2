...
Invoke-WebRequest -Uri https://github.com/azure-samples/azure-sql-db-session-recommender-v2/raw/classic/database/session_recommender_v2.dacpac -OutFile session_recommender_v2.dacpac
Invoke-WebRequest -Uri https://github.com/azure-samples/azure-sql-db-session-recommender-v2/raw/classic/database/master.dacpac -OutFile master.dacpac
